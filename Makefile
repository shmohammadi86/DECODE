...
SRC=src/mmio.cc src/io.cc src/DECODE.cc
OBJ=$(SRC:.cc=.o)

MATLAB_SRC=matlab/AssessFeatures.cc matlab/AssessFeatures_BetweenGroups.cc matlab/ProfileModule.cc
...
R: $(LIBNAME)
	...
	cp include/DECODE.h Rpackage/inst/include	
